...
export type WebEventPropertySet = Partial<{
  ...
  section_category:
    ...
    | "footer"
    | "unknown";
  navigation_path_category: "docs" | "catalog" | "blog" | "home" | "external" | "unknown";
  outbound_action_category: "github" | "npm" | "docs" | "catalog" | "blog" | "unknown";
  cta_category: "primary" | "secondary" | "install" | "docs" | "catalog" | "blog" | "unknown";

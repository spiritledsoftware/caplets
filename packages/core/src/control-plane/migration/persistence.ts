...
const ENTITY_TABLES: Readonly<Record<ControlPlaneEntityKind, ControlPlaneTable>> = {
  ...
  "artifact-manifest": "artifactManifests",
  "artifact-part": "artifactParts",
  "artifact-session": "artifactSessions",
  "artifact-quota-reservation": "artifactQuotaReservations",
  "import-proposal": "importProposals",
  "artifact-cleanup-intent": "artifactCleanupIntents",

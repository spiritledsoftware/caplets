...
| Is local or generic remote runtime worth more investment? | `caplets_cli_command`, `caplets_tool_activation`, `caplets_reliability_error`                   | `runtime_mode`, `surface`, `outcome`, `error_code`                                                                                                                          |

...
- Historical plan: [`docs/plans/2026-06-19-001-feat-unified-remote-attach-auth-plan.md`](../../plans/2026-06-19-001-feat-unified-remote-attach-auth-plan.md) records the earlier `--remote-url` and operator-minted Pairing Code shape and now carries a supersession note for those details.
